<x-guest-layout>
	<section class="min-h-screen w-full bg-gray-900">
		<div class="container relative mx-auto mt-4 flex min-h-screen flex-col px-3 py-5 pt-5">
			<div class="flex flex-1 items-center justify-center">
				<div class="flex w-full flex-col justify-center text-center">
					...
					<h1 class="text-center text-5xl font-extrabold lg:text-7xl 2xl:text-8xl">
						<span
							class="bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-amber-200 via-violet-600 to-sky-900 bg-clip-text text-transparent">
							Information System Communtiy
						</span>
					</h1>

					<p class="mx-auto mt-6 max-w-3xl text-center text-lg text-gray-700 dark:text-white md:text-xl">
						where enthusiastic thinkers and practitioners of information technology gather. Here, we build
						a strong network to exchange knowledge, experience, and innovative ideas in the field of
						information systems.
					</p>

					<a href="#" class="group relative mx-auto my-5 w-max">
						<div
						...
						<div
							class="relative flex justify-center rounded-lg bg-white px-4 py-3 leading-none ring-1 ring-gray-900/5">
							<div class="space-y-1">
								<p class="text-slate-800"><b>Daftar Sekarang!</b></p>
							</div>
						</div>
					</a>
					...
					<div class="mx-auto mt-20 max-w-screen-xl">
						<div class="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
							...
							<div class="col-span-1 flex items-center justify-center md:col-span-3 lg:col-span-1">
								<svg class="mt-1 h-5 fill-current text-gray-500 dark:text-gray-300"
							...
							<div class="col-span-2 flex items-center justify-center md:col-span-3 lg:col-span-1">
								<svg class="h-8 fill-current text-gray-500 dark:text-gray-300" viewBox="0 0 2270 546"
									xmlns="http://www.w3.org/2000/svg">
									<g fill-rule="evenodd">
										<path
	...
	<section class="py-4 dark:bg-gray-800 dark:text-gray-100">
		<div class="container mx-auto my-6 space-y-2 p-4 text-center">
			<h2 class="text-5xl font-bold">5 Bidang Fokus</h2>
			<p class="dark:text-gray-400">Libero minima optio qui</p>
		</div>
		<div class="flex flex-col overflow-hidden rounded-md py-4 shadow-sm lg:flex-row">
			<img src="https://source.unsplash.com/640x480/?1" alt=""
				class="aspect-video h-80 dark:bg-gray-500">
			<div class="flex flex-1 flex-col justify-center p-6 dark:bg-gray-900">
				...
				<h3 class="text-3xl font-bold">UI/UX Design</h3>
				<p class="my-6 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit.
					Dolor aliquam possimus quas, error esse quos.</p>
				<button type="button" class="self-start">Action</button>
			</div>
		</div>
		<div class="flex flex-col overflow-hidden rounded-md py-4 shadow-sm lg:flex-row-reverse">
			<img src="https://source.unsplash.com/640x480/?2" alt=""
				class="aspect-video h-80 dark:bg-gray-500">
			<div class="flex flex-1 flex-col justify-center p-6 dark:bg-gray-900">
				<span class="text-xs uppercase dark:text-gray-400">Join, it's free</span>
				<h3 class="text-3xl font-bold">Programming</h3>
				<p class="my-6 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit.
					Dolor aliquam possimus quas, error esse quos.</p>
				<button type="button" class="self-start">Action</button>
			</div>
		...
		<div class="flex flex-col overflow-hidden rounded-md py-4 shadow-sm lg:flex-row-reverse">
			...
			<div class="flex flex-1 flex-col justify-center p-6 dark:bg-gray-900">
				<span class="text-xs uppercase dark:text-gray-400">Join, it's free</span>
				<h3 class="text-3xl font-bold">IoT</h3>
				<p class="my-6 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit.
					Dolor aliquam possimus quas, error esse quos.</p>
				<button type="button" class="self-start">Action</button>
			</div>
		...
		<div class="flex flex-col overflow-hidden rounded-md py-4 shadow-sm lg:flex-row">
			...
			<div class="flex flex-1 flex-col justify-center p-6 dark:bg-gray-900">
				<span class="text-xs uppercase dark:text-gray-400">Join, it's free</span>
				<h3 class="text-3xl font-bold">Bisnis Plan</h3>
				<p class="my-6 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit.
					Dolor aliquam possimus quas, error esse quos.</p>
				<button type="button" class="self-start">Action</button>
			</div>
