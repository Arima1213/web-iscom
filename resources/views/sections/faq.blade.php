<section class="bg-white dark:bg-gray-900">
	<div class="container mx-auto grid gap-8 px-6 py-12 lg:grid-cols-3">
		<div>
			...
			<h1 class="mt-2 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">We’d love to
				hear from you</h1>

			<p class="mt-3 text-gray-500 dark:text-gray-400">Our friendly team is always here to chat.</p>
		</div>

		<div class="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:col-span-2">
			<div class="rounded-lg bg-blue-50 p-4 dark:bg-gray-800 md:p-6">
				<span class="inline-block rounded-lg bg-blue-100/80 p-3 text-blue-500 dark:bg-gray-700">
