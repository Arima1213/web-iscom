<section class="py-4 dark:bg-gray-800 dark:text-gray-100">
	<div class="mx-auto my-6 max-w-screen-xl space-y-2 p-4 text-center">
		<h2 class="text-5xl font-bold">Prestasi Komunitas</h2>
		<p class="dark:text-gray-400">Libero minima optio qui</p>
	</div>

	<div
		class="mx-auto mt-8 grid max-w-screen-xl grid-cols-1 justify-center gap-8 px-6 md:grid-cols-2 xl:mt-12 xl:grid-cols-3 xl:gap-12">
		<div class="group h-96 cursor-pointer overflow-hidden rounded-lg bg-cover"
			...
			<div
				class="flex h-full w-full flex-col justify-center bg-gray-800/60 px-8 py-4 opacity-0 backdrop-blur-sm transition-opacity duration-700 group-hover:opacity-100">
				<h2 class="mt-4 text-xl font-semibold capitalize text-white">Best website collections</h2>
		...
		<div class="group h-96 cursor-pointer overflow-hidden rounded-lg bg-cover"
			...
			<div
				class="flex h-full w-full flex-col justify-center bg-gray-800/60 px-8 py-4 opacity-0 backdrop-blur-sm transition-opacity duration-700 group-hover:opacity-100">
				<h2 class="mt-4 text-xl font-semibold capitalize text-white">Block of Ui kit collections</h2>
		...
		<div class="group h-96 cursor-pointer overflow-hidden rounded-lg bg-cover"
			...
			<div
				class="flex h-full w-full flex-col justify-center bg-gray-800/60 px-8 py-4 opacity-0 backdrop-blur-sm transition-opacity duration-700 group-hover:opacity-100">
				<h2 class="mt-4 text-xl font-semibold capitalize text-white">Ton’s of mobile mockup</h2>
