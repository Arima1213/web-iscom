<footer class="divide-y px-4 dark:bg-gray-800 dark:text-gray-100">
	<div
		class="container mx-auto flex flex-col justify-between space-y-8 py-10 lg:flex-row lg:space-y-0">
		<div class="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
				<div class="flex h-12 w-12 items-center justify-center rounded-full dark:bg-violet-400">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor"
						class="h-5 w-5 flex-shrink-0 rounded-full dark:text-gray-900">
						<path
	...
	<div class="py-6 text-center text-sm dark:text-gray-400">© 1968 Company Co. All rights reserved.
	</div>
</footer>
